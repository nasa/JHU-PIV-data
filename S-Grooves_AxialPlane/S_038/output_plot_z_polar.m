...
new_maskx1 = mesh_r.*sin(23.8*pi/180+d_theta+mask_theta)./95.7557;
new_masky1 = (mesh_r.*cos(23.8*pi/180+d_theta+mask_theta)-182.9)./45.72;



norm_theta_mask = all_data.norm_x_blade1*45.72/95.7557;
...
contour(new_x,new_y,uz/normvel1,'Color',[0.0,0.0,0.0],'LevelListMode','manual',...
    'LineWidth',1,'LevelList',[1],'LineStyle','--');
hold on

contour(new_x,new_y,uz/normvel1,'Color','w','LevelListMode','manual',...
...
hold on
g4 = patch(new_maskx1,new_masky1,[0.6,0.6,0.6],'EdgeColor','none');
hold on
% 
% plot(new_x(48,385),new_y(48,385),'o');
% hold on
...
% Add annotation
text(x_lim(1),y_lim(2)+(y_lim(2)-y_lim(1))/30,['U_{Z}' '/' 'V_{Z}'],'FontSize',font_size,'FontName',font_name,'FontWeight','bold');
...
% Add PS annotation
% text(0.12,0.71,'PS','Color','w','FontWeight','bold','FontSize',22);
% Add vector plots
